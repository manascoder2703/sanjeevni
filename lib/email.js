  ...
  await transporter.sendMail({
    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:480px;margin:0 auto;background:#f8fafc;padding:32px;border-radius:12px;">
        ...
        <p style="color:#475569;">Use the verification code below to access your Sanjeevni portal. This code expires in <strong>10 minutes</strong>.</p>
        <div style="background:white;border-radius:8px;padding:32px;text-align:center;margin:24px 0;border:2px dashed #0ea5e9;">
          <span style="font-size:42px;font-weight:900;letter-spacing:12px;color:#0ea5e9;">${otp}</span>
        </div>

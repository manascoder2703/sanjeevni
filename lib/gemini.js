...
"Intent Priority and Context Rules:\n" +
"- If a user mentions 'booking', 'appointment', or 'scheduling', ALWAYS use BOOK_DOCTOR intent.\n" +
"- If the user message is UNRELATED to the previous booking context (e.g. just saying 'hi', 'how are you'), DO NOT use BOOK_DOCTOR or PROVIDE_INFO. Use UNKNOWN intent.\n" +
"- NEVER include a 'Confirm Booking' or 'Draft' reminder in the AI reply for unrelated messages. Only mention the booking if specifically asked.\n" +
"- SEARCH_DOCTORS is only for browse/find requests.\n\n" +
...
"Role mismatch -> {intent:\"INVALID_ACTION\",params:{reason:\"unauthorized\"},reply:\"Unauthorized\"}.\n" +

            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center justify-between mb-2">
                  <FieldLabel htmlFor="password" title="Password" className="text-white text-[14px] font-bold">Password</FieldLabel>
                  <Link
                    href="/forgot-password"
                    className="text-[14px] text-zinc-500 hover:text-white transition-colors font-medium">
